...
| **Group**            | **Wk 3**                                | **Wk 4**                                     | **Wk 5**                                      | **Wk 6**                                       | **Wk 7**                                      | **Wk 8**                                        | **Wk 9**                                           | **Wk 10**                                        |
|----------------------|-----------------------------------------|----------------------------------------------|-----------------------------------------------|-----------------------------------------------|-----------------------------------------------|------------------------------------------------|--------------------------------------------------|--------------------------------------------------|
| **Frontend**          | Design Navigation (1)                  | Start front-end implementation (2)           | Test and connect front-end calls to backend (2) | Implement API to front-end calls (2)           | Develop user feedback features (2)             | Implement other features (e.g., notifications) (2) | Finalizing and testing (2)                      | Deploy and finish documentation (1)               |
| **Backend**           | Design for communication with WebSpeechAPI completed (1) | List of commands and functions determined (1)  | WebSpeechAPI coded into backend (2)           | Save Button Works / WebSpeechAPI implemented for add and remove functionality (2) | WebSpeechAPI fully implemented with full functionality into backend (2) | Testing and ensuring proper function of WebSpeechAPI (2) | Communication between frontend and backend is fully established (2) | TalkTask web page completed, deployed, and being maintained (1) |
| **UI/UX**             | UI Sketches (1)                        | Draft Figma wireframe UI design (2)           | Incorporate group feedback, draft designs for all UI elements/pages (2) | Visual styling decided, Unique visual assets generated (2) | Preliminary front end implemented with front end developers (3) | Test UI functionality for revisions (1)         | Make final changes for UI design and assets (1)  | Verify UI is functioning and correct (1)          |
| **Database**          | Design database schema (1)             | Set up MongoDB (1)                           | Configure database for tasks, users, reminders (2) | Implement save, update, and delete functionality (2) | Integrate AI and WebSpeech API with database (2) | Testing and ensuring database integrity (2)     | Ensure data sync between backend and database (2) | Final data structure testing and deployment (1)  |
| **Software Management** | Essential tools for web server setup (1)  | Files organized for easier implementation (1)  | Database implementation with correctly formatted data (2) | AI and WebSpeech APIs configured and ready for developers (2) | To-do list functionality fully implemented (3)  | Develop complex features (e.g., AI & speech recognition) (2) | Implement stretch goal features (2)              | Final system testing and deployment (2)          |
