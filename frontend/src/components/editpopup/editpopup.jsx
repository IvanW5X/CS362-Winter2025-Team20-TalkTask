    ...
    return (
        <>
            <div className="z-[10001] absolute inset-0 flex items-center justify-center bg-black/40">
                <form className="relative border-3 flex flex-col w-[900px] h-[700px] max-w-full max-h-full bg-gray-200 rounded-3xl items-center shrink overflow-auto"
                ...
                >
                    ...
                    <div className="flex flex-col items-start mt-4 w-full">
                        ...
                        <p className="flex flex-row mx-12 my-4">
                            <label htmlFor="title" className="bg-white m-3 p-2 rounded-2xl text-center w-[150px]">Title</label>
                        ...
                        <p className="flex flex-row items-center mx-12 my-4">
                            <label htmlFor="description" className="bg-white m-3 p-2 rounded-2xl text-center w-[150px]">Description</label>
                        ...
                        {/* Time Start */}
                        <p className="flex flex-row mx-12 my-4">
                            <label htmlFor="timeStart" className="bg-white m-3 p-2 rounded-2xl text-center w-[150px]">Time Start</label>
                        ...
                        {/* Completed By */}
                        <p className="flex flex-row mx-12 my-4">
                            <label htmlFor="timeEnd" className="bg-white m-3 p-2 rounded-2xl text-center w-[150px]">Completed By</label>
                            <input className="border-[2px] bg-white w-[130px] m-2 p-2"
                                type="time"
                                id="timeEnd"
                        ...
                        {/* Priority */}
                        <p className="flex flex-row mx-12 my-4">
                            <label htmlFor="priority" className="bg-white m-3 p-2 rounded-2xl text-center w-[150px]">Priority</label>
                            <select id="priority"
