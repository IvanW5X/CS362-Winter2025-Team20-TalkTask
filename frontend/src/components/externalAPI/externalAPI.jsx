// // Code taken but modified from: https://github.com/auth0-samples/auth0-react-samples/tree/master
...
//   const apiOrigin = "http://localhost:" + process.env.REACT_APP_SERVER_PORT;
...
export const ExternalApiComponent = () => {
  const audience = process.env.REACT_APP_AUTH0_AUDIENCE;
  const apiOrigin = process.env.VITE_BACKEND_URL;
  ...
  return (
    <>
      <div className="mb-5">
        ...
        <p>
          This will call a local API on port 51710 that would have been started
